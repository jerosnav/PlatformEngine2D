...
#pragma warning(disable : 4482) // Use of <enum>::enum_value
#pragma warning(disable : 4244) // conversion from 'irr::f32' to 'irr::s32', possible loss of data
#pragma warning(disable : 4018) // signed/unsigned mismatch
//---

//+++ Added to include assert information
#include <iostream>
#ifndef _DEBUG
	#define ASSERT(x, msg)
#else
	#define ASSERT(x, msg) \
		if (! (x)) \
		{ \
		std::cout << "ERROR!! Assert " << #x << " failed. " << msg << "\n"; \
